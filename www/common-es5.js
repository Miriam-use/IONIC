  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(AFauth, router, db, afDB) {
        ...
        _createClass(AuthService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      return _context3.abrupt("return", new Promise(function (resolve, rejected) {
          ...
          value: function register(email, password, name) {
            ...
            return new Promise(function (resolve, reject) {
              _this3.AFauth.createUserWithEmailAndPassword(email, password).then(function (res) {
                // console.log(res.user.uid);
                var uid = res.user.uid;

                _this3.db.collection('users').doc(uid).set({
                  name: name,
                  uid: uid
                });
          ...
          value: function getHeroes() {
            return this.afDB.list('heroes/').valueChanges(); //Esta función devolverá todos los datos que tengamos en el apartado heroes, en nuestra base de datos
          }
        }, {
          key: "saveHeroe",
          value: function saveHeroe(heroe) {
            var key = this.afDB.list('/heroes/').push(heroe).key; //Guardamos los alumnos y obetenemos el id que firebase pone al nudulo de nuestros alumnos.
          ...
          key: "updateHeroe",
          value: function updateHeroe(heroe) {
          ...
          value: function getHeroe(id) {
            return this.afDB.object('heroes/' + id).valueChanges(); //Devolvera el alumno con el id que le pasamos por parametro
          }
        }, {
          key: "removeHeroe",
          value: function removeHeroe(id) {
            this.afDB.database.ref('heroes/' + id).remove(); //Borrará el alumno con el id que le pasamos por parametro
          }
        }]);
